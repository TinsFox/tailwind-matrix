...
export const addExport = function addExport(tree, name, value) {
  tree.children.push({
    type: "export",
...
export const highlightCode = function highlightCode(code, prismLanguage) {
...
export const simplifyToken = function simplifyToken(token) {
